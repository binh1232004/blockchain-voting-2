...
export default function Home() {
    ...
    const { setDecreasedOERFromEthereum, OERDecreasedOnVote } = useOERVote(
        undefined,
        oer
    );

    useEffect(() => {
        if (!isLoading) setDecreasedOERFromEthereum();
    }, [isLoading]);

    useEffect(() => {}, [OERDecreasedOnVote]);
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100">
                <div className="text-center p-8 bg-white rounded-xl shadow-lg max-w-md mx-4">
                    ...
                    <p className="text-gray-600">
                        Unable to load educational resources. Please try again
                        later.
                    </p>
                    <button
            ...
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white py-16 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
                        Discover, vote, and support high-quality educational
                        content with our decentralized platform
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                            ...
                            <span className="text-sm font-medium">
                                {OERDecreasedOnVote.length} Resources Available
                            </span>
                        </div>
            ...
            <div className="container mx-auto px-4 py-12 relative z-10">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Browse through our curated collection of open
                        educational resources. Vote for your favorites and earn
                        OERT tokens!
                    </p>
                ...
                {OERDecreasedOnVote.length === 0 && (
                    <div className="text-center py-16">
                        ...
                        <p className="text-gray-600">
                            Check back later for new educational resources to
                            explore and vote on.
                        </p>
                    </div>
                )}
